...
<section id="recent-works">
    <div class="container">
        <div class="center wow fadeInDown">
            <br>
            <h2>Résultat de la compétition :<?php echo $comp->nom_comp; ?></h2>
        </div>
        <br>
        <br>
        <div class="row">
        ...
        <div class="CSSTableGenerator">
            <table >
                ...
                for ($index = 0; $index < count($performance_user); $index++) {
                    ...
                    echo '<tr>
                        ...
                        <td>
                                '.$performance_user[$index]->comptesCompetitions[0]->score.'
                        </td>
                         <td>
                                '.$performance_user[$index]->comptesCompetitions[0]->score.'
                        </td>
                        ...
                        <td>
                            <a href="?r=competition/viewPerfoCompUserforEntr&id_comp='.$id_comp.'&id_user='.$performance_user[$index]->id_compte.'">Afficher</a>
                        </td>
                        </tr>';
                }
                ?>
            ...
            for ($index = 0; $index < count($performance_user); $index++) {
                    ...
                    $record[$index]['data']=array(intval($performance_user[$index]->comptesCompetitions[0]->score));
            }
   ...
   'scripts' => array(
    ...
    'options'=>array(
      ...
      'title' => array('text' => 'Performance des utilisateurs'),
        'subtitle'=> array(
            'text'=>'Pour la compétition°'.$id_comp
        ),
      'xAxis' => array(
