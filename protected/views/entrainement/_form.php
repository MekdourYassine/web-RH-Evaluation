...
<?php echo $form->errorSummary($model); ?>
    ...
    <input placeholder="Note Minimale : /20" id="cre" value="1" type="radio" name="Test[note_min_test]">Créer des nouvelles questions</label>
        ...
        <?php echo $form->textAreaGroup($model,'auteur_entrain', array('widgetOptions'=>array('htmlOptions'=>array('rows'=>1, 'cols'=>10, 'class'=>'span8')))); ?>
...
<div class="form-actions">
	<?php $this->widget('booster.widgets.TbButton', array(
			'buttonType'=>'submit',
			'context'=>'primary',
                        'label' => $model->isNewRecord ? 'Créer l\'entraînement' : 'Save',
  		)); ?>
</div>
