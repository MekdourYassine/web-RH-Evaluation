            ...
            <table >
                ...
                for ($index = 0; $index < count($performance_user_entrain); $index++) {
                    ...
                    echo '<tr>
                        ...
                        <td>
                            <a href="?r=entrainement/viewPerfoEntrainUserEntr&id_entrain='.$performance_user_entrain[$index]->id_entrain.'&id_user='.$id_compte.'">Afficher</a>
                        </td>
                        </tr>';
                }
                ?>
