    ...
    <div class="container">
        ...
        <div class="CSSTableGenerator">
            <table >
                ...
                for ($index = 0; $index < count($performance_user); $index++) {
                    ...
                    echo '<tr>
                        ...
                        <td>
                                '.$performance_user[$index]->comptesEntrainements[0]->score.'
                        </td>
                         <td>
                                '.$performance_user[$index]->comptesEntrainements[0]->score.'
                        </td>
                        ...
                        <td>
                            <a href="?r=entrainement/viewPerfoEntrainUserEntr&id_entrain='.$id_entrain.'&id_user='.$performance_user[$index]->id_compte.'">Afficher</a>
                        </td>
                        </tr>';
                }
                ?>
            ...
            for ($index = 0; $index < count($performance_user); $index++) {
                    ...
                    $record[$index]['data']=array(intval($performance_user[$index]->comptesEntrainements[0]->score));
            }
   ...
   'scripts' => array(
    ...
    'options'=>array(
      ...
      'title' => array('text' => 'Performance des utilisateurs'),
        'subtitle'=> array(
            'text'=>'Pour l\'EntrainementN°'.$id_entrain
        ),
      'xAxis' => array(
