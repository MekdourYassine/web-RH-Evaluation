                        ...
                        <div class="overlay overlay1">
                            <div class="recent-work-inner">
                                ...
                                if (Yii::app()->user->checkAccess('user_entr'))
                                        {echo CHtml::link(CHtml::encode($data->nom_module),array('listemodule','id'=>$data->id_module));}
                                        else 
                                        {
                                            if (Yii::app()->user->checkAccess('public'))
                                                ...
                                                {
                                            echo CHtml::link(CHtml::encode($data->nom_module),array('view','id'=>$data->id_module));
                                        }}?> </a></h3>
