...
for ($index = 0; $index < count($modelRep); $index++) {
                 if ($modelRep[$index]->rep_compte==1) 
                    {
                        $nbrep=$nbrep+1;
                    }    
...
<section id="recent-works">
        <div class="container">
            ...
            <div class="row" style="text-align: center;">
                <h2 style=""> Votre score est : <b><?php echo $modelPer->score; ?> %</b></h2> <hint> (<?php echo $nbrep ?> bonnes réponses et <?php echo (count($modelRep)-$nbrep) ?> mauvaises réponses)</hint>
 ...
 <div class="CSSTableGenerator col-lg-12"  >
                ...
                for ($index = 0; $index < count($modelRep); $index++) {
                    ...
                    echo '<tr>
                        ...
                        echo '<td>
                            '.$modelRep[$index]->idQuest->duree_quest.'
                        </td>
