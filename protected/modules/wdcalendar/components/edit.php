    ...
    <div>      
      <div class="toolBotton">           
        <a id="Savebtn" class="imgbtn" href="javascript:void(0);">                
          <span class="Save"  title="Save the calendar">Sauvegarder(<u>S</u>)
          </span>          
        </a>                           
        <?php if(isset($event)){ ?>
        <a id="Deletebtn" class="imgbtn" href="javascript:void(0);">                    
          <span class="Delete" title="Cancel the calendar">Supprimer(<u>D</u>)
          </span>                
        </a>             
        <?php } ?>            
        ...
        <form action="<?php echo Yii::app()->controller->createUrl( '/wdcalendar/default/datafeed', array( 'method' => 'adddetails', 'id' => isset( $event ) ? $event->Id : '' ) ) ?>" class="fform" id="fmEdit" method="post"> 
          ...
          <label>                    
            ...
            <div>  
              ...
              <label class="checkp"> 
                <input id="IsAllDayEvent" name="IsAllDayEvent" type="checkbox" value="1" <?php if(isset($event)&&$event->IsAllDayEvent!=0) {echo "checked";} ?>/>          Toute la journée                      
              </label>                    
            </div>                
          </label>                 
          <label>                    
            ...
            <input MaxLength="200" id="Location" name="Location" style="width:95%;" type="text" value="<?php echo isset($event)?$event->Localisation:""; ?>" />                 
          </label>                 
          <label>                    
            <span>                        Remarques:
            </span>                    
